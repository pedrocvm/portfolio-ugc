    ...
    fields: [
      ...
      { k: 'area', path: 'plans.hintMensal', label: 'Explicação · mensal' },
      {
        ...
        blank: {
          name: '',
          best: false,
          avulso: { price: '', suffix: '', qty: '', unit: '' },
          mensal: { price: '', suffix: '/mês', qty: '', unit: '' },
          feat: [''],
        },
        item: [
          { k: 'text', path: 'name', label: 'Nome' },
          { k: 'bool', path: 'best', label: 'Marcar como recomendado' },
          { k: 'text', path: 'avulso.qty', label: 'Avulso · quantidade' },
          { k: 'text', path: 'avulso.price', label: 'Avulso · preço' },
          { k: 'text', path: 'avulso.suffix', label: 'Avulso · sufixo' },
          { k: 'text', path: 'avulso.unit', label: 'Avulso · preço por vídeo' },
          { k: 'text', path: 'mensal.qty', label: 'Mensal · quantidade' },
          { k: 'text', path: 'mensal.price', label: 'Mensal · preço' },
          { k: 'text', path: 'mensal.suffix', label: 'Mensal · sufixo' },
          { k: 'text', path: 'mensal.unit', label: 'Mensal · preço por vídeo' },
